        ...
        <Box mt="2rem" w="320px">
          <List>
            ...
            <ListItem float="left">
              <Flex direction="row">
                <Box float="left">
                  <Link style={{ textDecoration: "none" }}>Black Teas</Link>
                </Box>

                <ListItem mt="0.6rem" ml="13.8rem">
            ...
            <ListItem float="left">
              <Flex direction="row">
                <Box float="left" mt="0.6rem">
                  <Link style={{ textDecoration: "none" }}>
                    Herbal Teas Detox Benefit Blends
                  </Link>
                </Box>

                <ListItem mt="1.2rem" ml="3.8rem">
                  <Image src="	https://www.naturesbasket.co.in/Images/arrows-shop-by.png" />
                </ListItem>
              </Flex>
            </ListItem>
