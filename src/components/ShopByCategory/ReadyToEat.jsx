        ...
        <Box mt="2rem" w="320px">
          <List>
            ...
            <ListItem float="left">
              <Flex direction="row">
                <Box float="left">
                  <Link style={{ textDecoration: "none" }}>Hors'D Oeuvres</Link>
                </Box>

                <ListItem mt="0.6rem" ml="11.42rem">
            ...
            <ListItem float="left">
              <Flex direction="row">
                <Box float="left" mt="0.6rem">
                  <Link style={{ textDecoration: "none" }}>Soups Salads</Link>
                </Box>

                <ListItem mt="1.2rem" ml="12.5rem">
                  <Image src="	https://www.naturesbasket.co.in/Images/arrows-shop-by.png" />
                </ListItem>
              </Flex>
            </ListItem>
